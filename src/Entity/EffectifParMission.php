...
use App\Repository\EffectifParMissionRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=EffectifParMissionRepository::class)
 */
class EffectifParMission
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=FicheODE::class, inversedBy="effectifParMissions")
